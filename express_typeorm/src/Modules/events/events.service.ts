...
export class EventsService {
  ...
  async getEventsWithWorkshops() {
    ...
    const q = this.eventRepository.createQueryBuilder('events')
      .leftJoinAndSelect(
        'events.workshops',
        'workshops',
        'events.id = workshops.eventId'
      )
  ...
  async getFutureEventWithWorkshops() {
    ...
    const q = this.eventRepository.createQueryBuilder('events')
      ...
      .where(`workshops.start >= ${new Date().getTime()}`)
      .orWhere(`workshops.start IS NULL`)
